...
pub fn run() {
    ...
    let started = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::installed_apps::list_installed_applications,
            ...
            commands::tasks::list_tasks_for_date,
            commands::tasks::list_repeats_for_date,
            ...
            commands::notification::announce_break_over,
            ...
            commands::settings::get_daily_settings,
            ...
            commands::xp::get_daily_quests,
            commands::xp::list_quest_completions,
            commands::xp::complete_quest,
            commands::cleanup_actions::get_cleanup_day,
            ...
            commands::desktop::scan_desktop,
            commands::desktop::move_desktop_items,
            commands::desktop::delete_desktop_items,
            commands::desktop::open_desktop_item,
            commands::desktop::reveal_desktop_item,
            ...
            commands::storage::size_profile_folder,
